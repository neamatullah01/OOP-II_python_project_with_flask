    ...
    return (
        <footer className="footer p-10 bg-neutral text-neutral-content">
            <aside className="md:pl-10">
                ...
                <p>Olivia Cooks<br />Providing reliable tech since 1992</p>
            </aside>
            <nav>
                ...
                <p>olivia@cooks.com <br />Eighth Avenue 487, New York</p>
                <p className="pt-3">Copyright © 2023 - All right reserved</p>
            </nav>
        </footer>
    );
};
