    ...
    return (
        <div className="py-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-6">
                {
                    topFoods.map(food =>
                        <div key={food._id} className="card w-full lg:card-side bg-base-100 shadow-xl border border-black">
                            <figure><img className="w-full md:w-80 h-full" src={food.food_image} alt="Album" /></figure>
            ...
            <div className="flex justify-center pt-6">
                <Link to="/allFood" className="btn btn-outline bg-white text-[#892CDC]">See All Food</Link>
            </div>
        </div>
    );
};
