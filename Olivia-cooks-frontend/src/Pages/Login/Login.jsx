      ...
      <div className="hero-content flex-col lg:flex-row">
        <div className="w-1/2 h-[500px] mr-12 ">
          <img
            ...
            src={`https://cdn.dribbble.com/users/424937/screenshots/6717017/pasta_rice_cereals.png?resize=800x600&vertical=center`}
            alt=""
          />
        </div>
          ...
          <div className="card-body">
            ...
            <div>
              <button
                ...
                className="btn btn-block border border-black bg-white text-[#892CDC]"
              >
                Login With Google <BiLogoGoogle></BiLogoGoogle>
              </button>
            </div>
            <p className="my-4">
